...
class TextService
{
     ...
     * @return string
     */
    public static function morph($n, $f1, $f2, $f5): string
    {
        $n = abs(intval($n)) % 100;
    ...
    public static function ucFirst($str, $encoding = 'UTF8'): string
    {
        return mb_strtoupper(mb_substr($str, 0, 1, $encoding), $encoding) .
            mb_substr($str, 1, mb_strlen($str, $encoding), $encoding);
    }

    public static function loginToPhone($login): string
    {
        $first = substr($login, 0, 1);
        $plus = '';
        if($first == '7'){
            $plus = '+';
        }
